...
public class DiffMatchPatchTests {
    ...
    public static void beforeClass() {
        context = TestFramework.buildTestingContext("diff_tests");
    ...
    public void testDiffCharsToLines() {
        ...
        assertEquals("diff_charsToLines: Equality #1.", new Diff(EQUAL, "a"), new Diff(EQUAL, "a"));
    ...
    public void testDiffPrettyHtml() {
        ...
        assertEquals("diff_prettyHtml:", "<span class=\"equal\">a<br></span><del style=\"background:#ffe6e6;\">&lt;B&gt;b&lt;/B&gt;</del><ins style=\"background:#e6ffe6;\">c&amp;d</ins>", dmp.diff_prettyHtml(diffs));
    }
    ...
    private static List<Diff> diffList(Diff... diffs) {
        return new ArrayList<Diff>(Arrays.asList(diffs));
    }
