 ...
 */
public class HtmlParserSearchUtils {


    /**
     * search a string for a single
     ...
     */
    public static HtmlParseNode searchOne(String data, TagName tagName, Map<String, String> attributes) {
        var htmlParser = new HtmlParser();
        List<HtmlParseNode> nodes = htmlParser.parse(data);
     ...
     * </p>
     */
    public static List<HtmlParseNode> search(String data, TagName tagName, Map<String, String> attributes) {
        var htmlParser = new HtmlParser();
        List<HtmlParseNode> nodes = htmlParser.parse(data);
     ...
     * and an exception thrown if more than one found.
     */
    public static HtmlParseNode searchOne(String data, Map<String, String> attributes) {
        var htmlParser = new HtmlParser();
        List<HtmlParseNode> nodes = htmlParser.parse(data);
     ...
     * </p>
     */
    public static List<HtmlParseNode> search(String data, Map<String, String> attributes) {
        var htmlParser = new HtmlParser();
        List<HtmlParseNode> nodes = htmlParser.parse(data);
     ...
     * and an exception thrown if more than one found.
     */
    public static HtmlParseNode searchOne(String data, TagName tagName) {
        var htmlParser = new HtmlParser();
        List<HtmlParseNode> nodes = htmlParser.parse(data);
     ...
     * </p>
     */
    public static List<HtmlParseNode> search(String data, TagName tagName) {
        var htmlParser = new HtmlParser();
