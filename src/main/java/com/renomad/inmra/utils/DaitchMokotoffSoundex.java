...
public class DaitchMokotoffSoundex {
    ...
    private static final String RESOURCE_FILE = "/parsing_rules/dmrules.txt";
    ...
    static {
        try (final Scanner scanner = new Scanner(Objects.requireNonNull(DaitchMokotoffSoundex.class.getResourceAsStream(RESOURCE_FILE)), StandardCharsets.UTF_8)) {
