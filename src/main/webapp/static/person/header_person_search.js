...
// This is a script to enable providing suggestions when users search for people
// in the header bar
class HeaderPersonSearch {
   ...
   // The hidden input we'll set to an id, used when the user finds a person
    idInput;
    ...
    constructor() {
        this.searchInput = document.getElementById('nav_person_search')
        this.searchResultList = document.getElementById('nav_search_result_list');
        this.searchResultContainer = document.getElementById('nav_search_result_container');
    }
    ...
    addListener = () => {
        ...
        this.searchInput.addEventListener("keydown", this.arrowsHandler);
        ...
        this.searchInput.addEventListener("search", this.searchHandler);
    ...
    setSelectedDataInsideInput = (personDataElement) => {
        ...
        const id = personDataElement.getAttribute('data-personid')
        this.currentInput.value = personName;
    ...
    arrowsHandler = (e) => {
        ...
        elementToSelect = document.querySelectorAll('#nav_search_result_list > li')[this.selectedIndex];
        if (elementToSelect) {
    ...
    replaceSearchResults = (currentSearch, targetElement) => {
      // if they aren't searching for anything, just return
        ...
        this.idInput = document.getElementById('found_person_id');
        ...
        */
        fetch(
            ...
            .then((response) => {
                ...
                this.resultsCount = document.querySelectorAll('#nav_search_result_list > li').length
                ...
                if (this.resultsCount > 0) {
                    ...
                    parentElement.appendChild(this.searchResultContainer);
...
addEventListener("load", (event) => {
    const headerPersonSearch = new HeaderPersonSearch();
    headerPersonSearch.addListener();
});
